...
@Api(value = "SupplierController", description = "REST APIs Nhà cung cấp!!!!")
public class SupplierController {
    ...
    public ResponseBodyDto<Object> saveOrUpdate(
    		@RequestBody SupplierRequest request )throws Exception {
    	ResponseBodyDto<Object> dto = supplierService.save(request);
        return dto;
    }
    @GetMapping("/findById")
    public ResponseBodyDto<Object> findById(
    		@RequestParam(value = "id",required =  true)Long id )throws Exception {
    	ResponseBodyDto<Object> dto = supplierService.findById(id);
        return dto;
    }
    @PostMapping("/delete")
