            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <p style={{ fontFamily: "Times New Roman", textAlign: 'center', fontSize: 17 }}>
                  Ngày tạo : {dataEdit &&dataEdit.dateAdded&& format(new Date(dataEdit.dateAdded ), 'dd/MM/yyyy')|| ''}</p>
              </Grid>
              <Grid item xs={12}>
                <p style={{ fontFamily: "Times New Roman", textAlign: 'left', marginLeft: 65, fontWeight: "bold" }}>
                  Nhà cung cấp : {dataEdit && dataEdit.supplier && dataEdit.supplier.name || ''} </p>
                <p style={{ fontFamily: "Times New Roman", textAlign: 'left', marginLeft: 65, fontWeight: "bold" }}>
                  Địa chỉ : {dataEdit && dataEdit.supplier && dataEdit.supplier.address || ''}</p>
                <p style={{ fontFamily: "Times New Roman", textAlign: 'left', marginLeft: 65, fontWeight: "bold" }}>
                  SĐT : {dataEdit && dataEdit.supplier && dataEdit.supplier.phone || ''}</p>
              </Grid>
              <Grid item xs={12}>
                <Card >
